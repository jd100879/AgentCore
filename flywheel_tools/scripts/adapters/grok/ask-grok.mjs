...
Requires:
- ~/.flywheel/browser-profiles/grok-state.json (shared auth state)
...
(async function main() {
  ...
  const storageStatePath = path.join(process.env.HOME, ".flywheel", "browser-profiles", "grok-state.json");
